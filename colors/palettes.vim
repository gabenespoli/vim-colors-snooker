...
" Colors {{{1
let s:base03          = { "gui": "#1c1c1c", "cterm": "8"  }
let s:base02          = { "gui": "#262626", "cterm": "0"  }
let s:base01          = { "gui": "#4e4e4e", "cterm": "10" }
let s:base00          = { "gui": "#585858", "cterm": "11" }
let s:base0           = { "gui": "#808080", "cterm": "12" }
let s:base1           = { "gui": "#8a8a8a", "cterm": "14" }
let s:base2           = { "gui": "#b2b2b2", "cterm": "7"  }
let s:base3           = { "gui": "#c6c6c6", "cterm": "15" }

if &background == "dark"
  let s:bg            = s:base03
  let s:bg_subtle     = s:base02
  let s:darkgrey      = s:base01
  let s:lightgrey     = s:base00
  let s:norm          = s:base0
  let s:brightfg      = s:base1
  let s:white         = s:base2
  let s:brightwhite   = s:base3
else
  let s:bg            = s:base3
  let s:bg_subtle     = s:base2
  let s:darkgrey      = s:base1
  let s:lightgrey     = s:base0
  let s:norm          = s:base00
  let s:brightfg      = s:base01
  let s:white         = s:base02
  let s:brightwhite   = s:base03
endif

let s:red             = { "gui": "#d70000", "cterm": "1"  }
let s:orange          = { "gui": "#d75f00", "cterm": "9"  }
let s:yellow          = { "gui": "#d78700", "cterm": "3"  }
let s:pink            = { "gui": "#af5f87", "cterm": "5"  }
let s:purple          = { "gui": "#5f5faf", "cterm": "13" }
...
call s:h("Cursor",        {"bg": s:norm, "fg": s:bg })
call s:h("Comment",       {"fg": s:darkgrey, "gui": "italic", "cterm": "italic"})
...
call s:h("Todo",          {"fg": s:pink, "bg": s:bg_subtle, "gui": "italic", "cterm": "italic" })

" Extra Groups {{{1
" ordered according to `:help hitest.vim`

call s:h("SpecialKey",    {"fg": s:bg_subtle, "gui": "bold", "cterm": "bold"})
...
call s:h("MoreMsg",       {"fg": s:darkgrey})
hi! link ModeMsg MoreMsg
call s:h("LineNr",        {"fg": s:darkgrey})
call s:h("CursorLineNr",  {"fg": s:lightgrey})
call s:h("Question",      {"fg": s:red})
call s:h("StatusLine",    {"fg": s:brightfg, "bg": s:bg_subtle})
call s:h("Conceal",       {"fg": s:norm})
call s:h("StatusLineNC",  {"bg": s:bg_subtle, "fg": s:darkgrey})
call s:h("VertSplit",     {"bg": s:bg, "fg": s:bg})
call s:h("Title",         {"fg": s:brightwhite, "bg": s:bg_subtle, "gui": "bold", "cterm": "bold"})
call s:h("Visual",        {"bg": s:darkgrey, "fg": s:bg})
call s:h("VisualNOS",     {"bg": s:bg_subtle, "fg": s:bg})
call s:h("WarningMsg",    {"fg": s:bg, "bg": s:orange})
call s:h("WildMenu",      {"fg": s:bg_subtle, "bg": s:white})
call s:h("Folded",        {"fg": s:norm, "bg": s:bg_subtle})
call s:h("FoldColumn",    {"fg": s:norm})
call s:h("DiffAdd",       {"bg": s:bg_subtle, "fg": s:green})
call s:h("DiffDelete",    {"bg": s:bg_subtle, "fg": s:red})
call s:h("DiffChange",    {"bg": s:bg,        "fg": s:norm})
call s:h("DiffText",      {"bg": s:bg_subtle, "fg": s:yellow})
...
if has("gui_running")
  ...
  call s:h("SpellBad",    {"cterm": s:sp_un, "fg": s:norm})
  call s:h("SpellCap",    {"cterm": s:sp_un, "fg": s:norm})
  call s:h("SpellRare",   {"cterm": s:sp_un, "fg": s:norm})
  call s:h("SpellLocal",  {"cterm": s:sp_un, "fg": s:norm})
endif
call s:h("Pmenu",         {"fg": s:norm, "bg": s:bg_subtle})
call s:h("PmenuSel",      {"fg": s:bg, "bg": s:blue})
call s:h("PmenuSbar",     {"fg": s:norm, "bg": s:bg_subtle})
call s:h("PmenuThumb",    {"fg": s:norm, "bg": s:bg_subtle})
" call s:h("Pmenu",         {"fg": s:bg_subtle, "bg": s:norm})
" call s:h("PmenuSel",      {"fg": s:white, "bg": s:lightgrey})
" call s:h("PmenuSbar",     {"fg": s:norm, "bg": s:white})
" call s:h("PmenuThumb",    {"fg": s:bg, "bg": s:norm})
call s:h("TabLine",       {"fg": s:lightgrey, "bg": s:bg_subtle})
call s:h("TabLineSel",    {"fg": s:white, "bg": s:bg_subtle, "gui": "bold", "cterm": "bold"})
call s:h("TabLineFill",   {"fg": s:lightgrey, "bg": s:bg_subtle})
...
call s:h("qfLineNr",      {"fg": s:lightgrey})
...
call s:h("pandocEmphasis",          {"fg": s:brightfg, "gui": "italic", "cterm": "italic"})
call s:h("pandocStrong",            {"fg": s:brightfg, "gui": "bold", "cterm": "bold"})
call s:h("pandocStrongEmphasis",    {"fg": s:brightfg, "gui": "bold,italic", "cterm": "bold,italic"})
...
call s:h("NERDTreeLinkTarget",      {"fg": s:norm})
